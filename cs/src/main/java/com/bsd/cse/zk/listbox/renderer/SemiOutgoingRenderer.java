...
public class SemiOutgoingRenderer implements ListitemRenderer{
    ...
    public void render(Listitem lstm, Object o) throws Exception {
        ...
        else if(o instanceof SemiStockTran)
        {
            SemiStockTran object = (SemiStockTran)o;
            ...
            cell = new Listcell();
            cell.appendChild(new Label(String.valueOf(object.getPart().getSemiMaterial().getSemiName()+"-"+object.getPart().getSemiMaterial().getSemiType().getName())));
            cell.setParent(lstm);
            cell.setSclass("cell-align-left");
              

            cell = new Listcell();
            cell.appendChild(new Label(String.valueOf(object.getPart().getSemiMaterial().getSize())));
            cell.setParent(lstm);
            cell.setSclass("cell-align-left");
