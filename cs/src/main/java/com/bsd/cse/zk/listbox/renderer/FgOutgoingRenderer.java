...
public class FgOutgoingRenderer implements ListitemRenderer{
    ...
    public void render(Listitem lstm, Object o) throws Exception {
        ...
        else if(o instanceof FgStockTran)
        {
            ...
            Listcell cell = new Listcell();
            cell.appendChild(new Label(String.valueOf(object.getTransferType()==null?"":object.getTransferType().getTransferTypeName())));
            cell.setParent(lstm);
