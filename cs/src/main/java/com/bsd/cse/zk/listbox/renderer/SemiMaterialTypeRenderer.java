 ...
 * @author bento
 */
public class SemiMaterialTypeRenderer implements ListitemRenderer{
    ...
    public SemiMaterialTypeRenderer(Window win,Textbox idTxt,Textbox nameTxt,Textbox descTxt,Toolbarbutton searchBtn)
    {
        this.win = win;
        this.idTxt = idTxt;
    ...
    public void render(Listitem lstm, Object o) throws Exception {
        ...
        else if(o instanceof SemiType)
        {
            SemiType object = (SemiType)o;
...
//            cell.setSclass("cell-align-left");
            ...
            editBtn.setTooltiptext(ResourceUtil.getLabel("backoffice.semimaterialtype.page.btn.edit"));
            ...
            deleteBtn.setTooltiptext(ResourceUtil.getLabel("backoffice.semimaterialtype.page.btn.delete"));
    ...
    class EditObjectEventListener implements EventListener
    {
        ...
        public void onEvent(Event event) throws Exception {
            SemiType object = (SemiType)event.getTarget().getAttribute("object");
    ...
    class DeleteObjectEventListener implements EventListener
    {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            SemiType object = (SemiType)event.getTarget().getAttribute("object");
            int messageValue = AlertMessages.confirmMessage("backoffice.semimaterialtype.alert.message.4");
            ...
            {
                AlertMessages.alertMessage("backoffice.semimaterialtype.alert.message.5");
                return ;
            }
            ...
            {
                AlertMessages.alertMessage("backoffice.semimaterialtype.alert.message.6");
                Events.sendEvent(Events.ON_CLICK,searchBtn, null);
            }
            else
            {
                AlertMessages.alertMessage("backoffice.semimaterialtype.alert.message.7");
            }
        }
