...
public class RawIncomingRenderer implements ListitemRenderer{
    ...
    public void render(Listitem lstm, Object o) throws Exception {
        ...
        else if(o instanceof RawStockTran)
        {
            RawStockTran object = (RawStockTran)o;
            ...
            cell = new Listcell();
            cell.appendChild(new Label(String.valueOf(object.getPart().getSemiMaterial().getRawMaterial().getRawName()+"-"+object.getPart().getSemiMaterial().getRawMaterial().getRawType().getName())));
            cell.setParent(lstm);
            cell.setSclass("cell-align-left");
              

            cell = new Listcell();
            cell.appendChild(new Label(String.valueOf(object.getPart().getSemiMaterial().getRawMaterial().getSize())));
            cell.setParent(lstm);
            cell.setSclass("cell-align-left");
