...
public class RoleCore {
    private static Log LOG = LogFactory.getLog(RoleCore.class);

    public static List<Role> getAllRoleTree() throws Exception
    {
        final HashMap<String,List<Role>> map = new HashMap<String,List<Role>>();
        ...
        return (List<Role>)map.get("results");
    }
